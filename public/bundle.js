...
var module$1 = "data:application/wasm;base64,AGFzbQEAAAABDAJgAn9/AX9gAX8BfwMDAgABBQMBAAAHFgMDYWRkAAADZmliAAEGbWVtb3J5AgAKPQIHACAAIAFqCzMBA39BASEBIABBAEoEQANAIABBAWsiAARAIAEgAmohAyABIQIgAyEBDAELCyABDwtBAAsAJhBzb3VyY2VNYXBwaW5nVVJMFC4vb3B0aW1pemVkLndhc20ubWFw";

var getInterface = function () {
    return instantiate(fetch(module$1)).then(function (_a) {
        var exports = _a.exports;
        return exports;
    });
};

getInterface().then(function (ex) {
    var add = ex.add, fib = ex.fib;
    console.log(add(3, 4));
    console.log(fib(18));
    console.log(ex);
});
